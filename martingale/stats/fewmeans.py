...
from martingale.stats.fewmeansdefaultparams import FEWMEANS_DEFAULT_FADING_FACTORS
...
class FEWMeans:
    ...
    def __init__(self, fading_factors=None, var_fading_factor=0.01, buffer_size=5, epsilon=1e-9):
        if fading_factors is None:
            fading_factors = [ff for ff in FEWMEANS_DEFAULT_FADING_FACTORS]
